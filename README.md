...
Coller un texte : Extraction de mots-clés à partir d'un texte fourni.
Coller une URL : Analyse de contenu d'une URL via TextRazor et extraction de mots-clés.
Entrer un mot-clé : Recherche des résultats Google SERP et analyse des URLs avec TextRazor et YAKE.
Installation
Prérequis
Python 3.x
...
Options disponibles
Extraction de texte : Collez un texte et obtenez les mots-clés extraits par YAKE.
Analyse d'URL : Entrez une URL pour obtenir les mots-clés à partir du contenu de la page analysée par TextRazor.
Recherche SERP : Entrez un mot-clé et une localisation pour obtenir les résultats SERP, puis analysez les mots-clés des 10 premières URL.
Fonctionnalités
